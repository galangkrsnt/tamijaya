...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Tambah Bus</div>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="no_bus" type="text" class="form-control @error('no_bus') is-invalid @enderror" name="no_bus">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="plat_nomor" type="text" class="form-control @error('plat_nomor') is-invalid @enderror" name="plat_nomor">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="harga_tiket" type="text" class="form-control @error('harga_tiket') is-invalid @enderror" name="harga_tiket">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="jumlah_kursi" type="text" class="form-control @error('jumlah_kursi') is-invalid @enderror" name="jumlah_kursi">
